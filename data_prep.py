...
def get_genre():
    ...
    df.to_csv('data/genre_id.csv', encoding='utf-8', index=False)
...
def data_prep():
    ...
    # write into csv file
    df.to_csv('data/movie_id.csv', encoding='utf-8', index=False)
    ...
    result.to_csv('data/movie_info.csv', encoding='utf-8', index=False)
    #len = 8
    return df_lst
